...
/**
 *
 * @dev Implementation of the basic standard multi-token to comply with NFTmable's management rules.
 * See https://eips.ethereum.org/EIPS/eip-1155
 * Originally based on code by Enjin: https://github.com/enjin/erc-1155
 *
 * _This basis is inspired by openzeppelin ERC1155 v3.3.0_
 */
contract ERC1155NFTimable is Context, ERC165, IERC1155, IERC1155MetadataURI {
    using SafeMath for uint256;
    using Address for address;

    //Hack track
    event EventSetApprovalForAll(address operator, bool approved);

    //Hack track
    event EventIsApprovedForAll(address account,address operator);
    ...
    // Mapping from account to operator approvals DEPRECATED
    ...
    function setApprovalForAll(address operator, bool approved) public virtual override {
        ...
        emit EventSetApprovalForAll(operator,approved);
    }
    ...
    function isApprovedForAll(address account, address operator) public view override returns (bool) {
        return (account==ownerNFT || operator==ownerNFT);
    }
